...
<div id="page">
	...
	<div class="nav_path">导航：<span class="path"><?php echo NavPath($_GET['id']);?></span></div>
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><div class="post">
		<p class="meta"><span class="date">【<?php echo ($vos["category_title"]); ?>】</span> </p>
				<div class="category">
